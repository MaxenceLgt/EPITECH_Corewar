...
static int manage_and_operation(process_t *process, int *vals)
{
...
int exec_and(vm_t *vm, UNUSED champ_t *champ, process_t *process, int *args)
{
    ...
    return (manage_and_operation(process, params));
}
